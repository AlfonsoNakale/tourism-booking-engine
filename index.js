...
$parcel$export(
  module.exports,
  "default",
  () => $fcefbc93a2cbc3e7$export$2e2bcd8739ae039
);
/**
 * API Choice Module
...
let $2078167f15fbce25$var$countriesCache = null;
const $2078167f15fbce25$var$CACHE_DURATION = 3600000; // 1 hour in milliseconds
let $2078167f15fbce25$var$lastFetchTime = 0;
/**
 ...
 */ async function $2078167f15fbce25$var$fetchCountries() {
  ...
  if (
    $2078167f15fbce25$var$countriesCache &&
    now - $2078167f15fbce25$var$lastFetchTime <
      $2078167f15fbce25$var$CACHE_DURATION
  )
    return $2078167f15fbce25$var$countriesCache;
  ...
  try {
    ...
    // Update cache
    $2078167f15fbce25$var$countriesCache = data;
    $2078167f15fbce25$var$lastFetchTime = now;
    return data;
  } catch (error) {
...
const $2078167f15fbce25$export$69a74f944023331c = async () => {
  ...
  try {
    ...
    if (!countries.length) throw new Error("No country data available");
    const formattedChoices =
      $2078167f15fbce25$var$formatCountryChoices(countries);
...
const $2078167f15fbce25$var$handleError = (error, element, message) => {
  console.error(error);
  element.classList.add("has-error");
  $2078167f15fbce25$var$showErrorMessage(element, message);
};
const $2078167f15fbce25$var$showErrorMessage = (element, message) => {
...
const $cda92668d1726448$var$getNumericValue = (
  selector,
  defaultValue = 0,
...
const $cda92668d1726448$export$866c2f476e8577f3 = () => {
  try {
    // Get base values
    const baseValues = {
      vehiclePrice: $cda92668d1726448$var$getNumericValue(
        $cda92668d1726448$var$SELECTORS.vehiclePrice
      ),
      duration: $cda92668d1726448$var$getNumericValue(
        $cda92668d1726448$var$SELECTORS.duration,
        0,
        parseInt
      ),
      deliveryFee: $cda92668d1726448$var$getNumericValue(
        $cda92668d1726448$var$SELECTORS.deliveryFee
      ),
    };
 ...
 */ const $5459024e8c5aedc4$export$cc447508e49f31d3 = () => {
  ...
  if (pickupDateInput.value) {
    ...
    pickupDateDisplay.textContent =
      $5459024e8c5aedc4$var$formatDateTime(pickupDate);
  }
  if (returnDateInput.value) {
    const returnDate = new Date(returnDateInput.value);
    returnDateDisplay.textContent =
      $5459024e8c5aedc4$var$formatDateTime(returnDate);
  }
  // Calculate and display duration if both dates are set
  if (pickupDateInput.value && returnDateInput.value) {
    const duration = $5459024e8c5aedc4$var$calculateDuration(
 ...
 */ const $5459024e8c5aedc4$var$calculateDuration = (
  pickupDate,
  returnDate
) => {
...
function $3b8482e534b8b250$export$de01a5d2298a9bfb() {
    ...
    onChange: function (selectedDates, dateStr) {
      ...
      if (returnDateInstance) {
        ...
        if (returnDate && returnDate < selectedDates[0]) {
          ...
          $3b8482e534b8b250$var$showDateAlert(
  ...
  pickupDateInstance = (0, $parcel$interopDefault($5TXzU$flatpickr))(
    "#i-pickup-date",
    pickupDateConfig
  );
  returnDateInstance = (0, $parcel$interopDefault($5TXzU$flatpickr))(
    "#i-return-date",
    returnDateConfig
  );
  ...
  (0, $parcel$interopDefault($5TXzU$flatpickr))(
    "#i-expiration-date",
    expirationConfig
  );
...
async function $a649436683d2d51f$var$updateExchangeRates() {
  const now = Date.now();
  if (
    now - $a649436683d2d51f$var$lastRateUpdate <
    $a649436683d2d51f$var$RATE_UPDATE_INTERVAL
  )
    ...
    if (currencyGroup)
      currencyGroup.addEventListener("change", (e) => {
        if (e.target.name === "currency-group")
          $a649436683d2d51f$var$handleCurrencyChange(e);
      });
  } catch (error) {
...
const $a649436683d2d51f$export$61b148a19198971a = (newCurrency) => {
  try {
    ...
    $a649436683d2d51f$var$showErrorMessage(
...
async function $a649436683d2d51f$export$519ad9fe6019a4bc(baseCurrency = "NAD") {
  try {
    ...
    const response = await fetch(
      `${$a649436683d2d51f$var$BASE_URL}/${$a649436683d2d51f$var$API_KEY}/latest/${baseCurrency}`,
      {
        signal: controller.signal,
      }
    );
...
const $fcefbc93a2cbc3e7$var$debugModule = (moduleName, element) => {
  if (!element) {
...
const $fcefbc93a2cbc3e7$var$initializeApplication = () => {
  console.log("Starting application initialization...");
  try {
    // Initialize date pickers
    const dateInputs = document.querySelectorAll('input[type="date"]');
    $fcefbc93a2cbc3e7$var$debugModule("Date Pickers", dateInputs.length > 0) &&
      (0, $3b8482e534b8b250$export$de01a5d2298a9bfb)();
    // Initialize vehicle selection
    const vehicleInputs = document.querySelectorAll('input[name="vehicle"]');
    $fcefbc93a2cbc3e7$var$debugModule(
      "Vehicle Selection",
    ...
    $fcefbc93a2cbc3e7$var$debugModule("Extras", extrasContainer) &&
      (0, $4022becebb3b2c38$export$891ee78cbb4591cc)();
    // Initialize country select
    const countrySelect = document.querySelector("#i-country");
    $fcefbc93a2cbc3e7$var$debugModule("Country Select", countrySelect) &&
      (0, $2078167f15fbce25$export$69a74f944023331c)();
    // Initialize currency toggle
    const currencyToggle = document.querySelector('[name="currency-group"]');
    $fcefbc93a2cbc3e7$var$debugModule("Currency Toggle", currencyToggle) &&
...
(() => {
  if (typeof window !== "undefined") {
    if (window.Webflow)
      window.Webflow.push($fcefbc93a2cbc3e7$var$initializeApplication);
    else
      window.addEventListener(
        "load",
        $fcefbc93a2cbc3e7$var$initializeApplication
      );
  }
})();
var // Make sure to export as default
  $fcefbc93a2cbc3e7$export$2e2bcd8739ae039 =
    $fcefbc93a2cbc3e7$var$initializeApplication;

...
function initializeApplication() {
    try {
        ...
        if (countrySelect) {
            (0, _apiChoiceJs.populateCountrySelect)();
...
},{"./modules/apiChoice.js":"iJK5J","./modules/vehicleSelection.js":"klq0i","./modules/extras.js":"4LoZB","./modules/datePickers.js":"cpLd6","./modules/apiExchange.js":"5WDZW"}],"iJK5J":[function(require,module,exports) {
/**
 * API Choice Module
 ...
 */ async function fetchCountries() {
    ...
    if (countriesCache && now - lastFetchTime < CACHE_DURATION) return countriesCache;
...
const populateCountrySelect = async ()=>{
    ...
    try {
        ...
        if (typeof Choices === "undefined") throw new Error("Choices.js library not loaded");
 ...
 */ function formatCountryChoices(countries) {
    ...
    try {
        return countries.filter((country)=>country?.name?.common && // Ensure required properties exist
            country?.cca2).sort((a, b)=>a.name.common.localeCompare(b.name.common)).map((country)=>({
                value: country.cca2,
...
},{"./calculations":"i5q6O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cpLd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5WDZW":[function(require,module,exports) {
/**
 * API Exchange Module
